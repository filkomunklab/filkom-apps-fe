...
const VisionMissionGoals = () => {
    return (
      <div>
        <Typography sx={{ fontSize: "24px", fontWeight: 500, paddingBottom: '24px'}}>
          Vision, Mission, and Goals
        </Typography>
        <div sx={{flex: 1}} >
              <Accordion>
                    <AccordionSummary  sx={{ paddingLeft: '24px' }}
                    ...
                    <AccordionDetails>
                        <Typography sx={{ paddingLeft: '26px',paddingRight:'26px', textAlign: 'justify'}}>
              ...
              <Accordion>
                    ...
                    <AccordionDetails>
                      <Typography sx={{ paddingLeft: '26px' }}>
                      ...
                      <Typography sx={{paddingLeft: '26px', paddingRight:'26px', textAlign: 'justify'}}>
                        <ol sx={{ listStylePosition: 'inside'}}>
                          <li>
                            Menuntun mahasiswa dalam pembentukan karakter Kristiani yang ditandai dengan kerajinan, kejujuran, penghematan, pengendalian-diri, dan kekudusan.
                          </li>
                          <li >
                            Memanfaatkan hasil penelitian dan teknologi semaksimal mungkin untuk memastikan pembelajaran yang bersifat student-centered and student-oriented.
                          </li>
                          <li>
                            Membekali mahasiswa dengan ketrampilan dan penerapan ilmu pengetahuan dan teknologi yang ditekuninya.
                          </li>
                          <li>
                            Meningkatkan penelitian dosen dengan melibatkan mahasiswa.
                          </li>
                          <li>
                            Menerapkan ilmu pengetahuan dan teknologi semaksimal mungkin dalam bentuk pengabdian kepada masyarakat dengan melibatkan dosen, staf, dan mahasiswa.
                          </li>
                        </ol>
                      </Typography>
                     </AccordionDetails>
