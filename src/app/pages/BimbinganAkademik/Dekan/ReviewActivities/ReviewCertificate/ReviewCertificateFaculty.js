...
const data = Array.from(Array(15).keys()).map((item, index) => ({
  nim: `105022010000`,
  submission_date: `Nov 12, 2023`,
  name: `Katong, Ovel Darill`,
  title: `Juara 1 Coding Competition se Kelurahan`,
  category: `Faculty`,
  supervisor_name: `Kalalo, Jerico Richie`,
  status: `Waiting`,
}));

const ReviewCertificateFaculty = () => {
      ...
      <Grid container spacing={2}>
        <Grid display={"flex"} alignItems={"flex-end"} item md={6}>
          <Typography variant="h3">
            Review Student Faculty Certificates
          </Typography>
        </Grid>
        <Grid item md={3}>
...
export default ReviewCertificateFaculty;
