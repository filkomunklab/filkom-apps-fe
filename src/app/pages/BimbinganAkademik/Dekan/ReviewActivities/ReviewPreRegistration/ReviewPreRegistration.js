...
const ReviewPreRegistration = () => {
  ...
  const TableItem = ({ item, index }) => {
    ...
    const handleButtonNavigate = () => {
      navigate(
        `/bimbingan-akademik/dekan/review-activities/pre-registration/${item.nim}`
      );
    };
    return (
      <TableRow
  ...
  return (
    <Div>
      ...
      <Typography variant="h6" sx={{ mb: 3 }}>
        This page contains information related to filling out the Study Plan
        Card. Students, especially your guidance students. You can use filter to
        sort the list of students to get the information you are looking for.
      </Typography>
