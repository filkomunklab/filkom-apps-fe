    ...
    <div>
      <div role="presentation" onClick={handleClick}>
        <Breadcrumbs aria-label="breadcrumb">
          <StyledLink onClick={(event) => handleClick(event, -4)}>
            History
          </StyledLink>
          ...
          <Typography color="text.primary">Students PreRegistration</Typography>
        </Breadcrumbs>
      </div>
      <Typography
        fontSize={"24px"}
        ...
        <Grid item xs={12}>
          <Grid container>
            ...
            <Grid item xs={7} paddingLeft={1}>
              <Typography
                variant="h5"
                sx={{ color: isApproved ? "#005fdb" : "#ca150c" }}
              >
...
export default StudentPreRegis;
