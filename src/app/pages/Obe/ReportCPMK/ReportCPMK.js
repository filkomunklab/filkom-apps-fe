      ...
      <div className="bg-secondary rounded-2xl p-5 flex flex-row mb-10">
        <table className="w-full">
          <tbody>
            ...
            <tr>
              <td className="text-lg font-semibold w-40">Tahun Kurikulum</td>
        ...
        <div>
          <TableContainer component={Paper}>
            <Table aria-label="simple table">
              ...
              <TableBody>
                {reportDetailQuery.data?.studentCpmkGrade.map((row, index) => (
                  <TableRow
                    key={row.nim}
                    hover
              ...
              <TableRow className="bg-primary *:!text-white">
                ...
                {reportDetailQuery.data?.cpmkGradeSummary.avgEach.map(
                  (item, index) => (
                    <TableCell key={index}>{item.average.toFixed(2)}</TableCell>
                  )
                )}
                <TableCell>
