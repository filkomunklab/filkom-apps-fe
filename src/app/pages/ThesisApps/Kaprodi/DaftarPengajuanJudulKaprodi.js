                            ...
                            (submission, submissionIndex) => (
                              <TableRow key={submissionIndex}>
                                ...
                                <TableCell>
                                  <Typography
                                    component={Link}
                                    to={`/sistem-informasi-skripsi/daftar-pengajuan-judul-kaprodi/beranda/${submission.group_id}/KAPRODI`}
                                    sx={{
                                      textDecoration: "none",
                                      color: "blue",
                                    }}
                      ...
                      (submission, submissionIndex) => (
                        <TableRow key={submissionIndex}>
                          ...
                          <TableCell>
                            <Typography
                              component={Link}
                              to="/sistem-informasi-skripsi/daftar-pengajuan-proposal-dosen-skripsi/beranda/4353987/kaprodi"
                              sx={{
                                textDecoration: "none",
                                color: "blue",
                              }}
...
export default DaftarPengajuanJudulKaprodi;
