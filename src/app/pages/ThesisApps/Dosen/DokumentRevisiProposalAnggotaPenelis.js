...
const DocumentRevisiProposalAnggotaPenelis = () => {
  ...
  const [anggotaPenelisStatus, setAnggotaPenelisStatus] = useState([]);
  ...
  const handleActionClick = (index, status) => {
    ...
    setAnggotaPenelisStatus(status);
...
export default DocumentRevisiProposalAnggotaPenelis;
