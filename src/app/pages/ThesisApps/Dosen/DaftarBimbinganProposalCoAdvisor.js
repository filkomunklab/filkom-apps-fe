...
const DaftarBimbinganProposalCoAdvisor = () => {
  ...
  const handleSearch = () => {
    const results = daftarBimbinganProposal.semesterData.flatMap(
      (semesterData) =>
    ...
    const fetchDaftarBimbinganProposalData = async () => {
      try {
        const response = await axios.get(
          "http://localhost:2000/api/v1/group/proposal-list-co-advisor",
          {
            headers: {
  ...
  return (
    <Div>
      ...
      >
                    ...
                    {searchResults.map((proposal, proposalIndex) => (
                      <TableRow key={proposalIndex}>
                        ...
                        <TableCell>
                          <Typography
                            component={Link}
                            to={`/sistem-informasi-skripsi/daftar-bimbingan-proposal-co-advisor/beranda/${proposal.group_id}/${proposal.status_co_advisor}`}
                            sx={{
                              textDecoration: "none",
                              color: "blue",
                            }}
        ...
        {/* Header End */}
        {/* Semester Start */}
        {daftarBimbinganProposal?.semesterData?.length > 0 ? (
          <Div
            sx={{
              display: "inline-flex",
              flexDirection: "column",
          ...
          >
            ...
            >
              Belum ada mahasiswa yang dibimbing proposal.
            </Typography>
          </Div>
        )}
...
export default DaftarBimbinganProposalCoAdvisor;
