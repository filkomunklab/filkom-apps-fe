...
const MengisiBeritaAcaraProposalAdvisor = () => {
  ...
  const [AdvisorStatusBeritaAcara, setAdvisorStatusBeritaAcara] =
    useState("Belum");

  const [AdvisorStatusPerubahan, setAdvisorStatusPerubahan] = useState("Belum");
  ...
  const handleSignClick = () => {
    ...
    if (!isSigned) {
      setAdvisorStatusBeritaAcara("Sudah");
      setIsSigned(true);
    }
  };
  ...
  const handleSudmitClick = () => {
    ...
    if (!isSudmit) {
      setAdvisorStatusPerubahan("Sudah");
      setIsSudmit(true);
    }
  };
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      <Chip
                        label={AdvisorStatusBeritaAcara}
                        size="small"
                        sx={{
                          background: isSigned
                            ? "rgba(21, 131, 67, 0.10)"
...
export default MengisiBeritaAcaraProposalAdvisor;
