...
const BukaBeritaAcaraProposalKetuaPenelis = () => {
  // Menu horizontal
  ...
  const handleBukaKonfirmasi = () => {
    // Lakukan tindakan saat tombol "Buka" dikonfirmasi
    // Misalnya, lakukan pembukaan berita acara proposal
    // dan kemudian tutup dialog konfirmasi
    setIsConfirmDialogOpen(false);
  };
  return (
    <Div>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <DialogTitle
                sx={{ color: "#0A0A0A", fontSize: "20px", fontWeight: "500px" }}
              >
...
export default BukaBeritaAcaraProposalKetuaPenelis;
