            ...
            >
              {isEditing ? (
                ...
                <Typography variant="subtitle1">
                  Batas pengumpulan revisi: {formatDateForDisplay(date)}
                </Typography>
              )}
              ...
              {isEditing ? (
                ...
                <Div hidden={userRole.includes("KETUA_PANELIS") ? false : true}>
                  <Button
                    size="small"
                    variant="contained"
...
export default DokumenRevisiProposal;
