...
const DaftarBimbinganSkripsiCoAdvisor = () => {
    ...
    const fetchDaftarBimbinganSkripsiData = async () => {
      try {
        const response = await axios.get(
          "http://localhost:2000/api/v1/group/skripsi-list-co-advisor",
          {
            headers: {
        ...
        // Atur state 'setDaftarBimbinganSkripsi' dengan data dari respons
        setDaftarBimbinganSkripsi(response.data.data);
      ...
      >
        ...
        >
          ...
          <Div>
            ...
            >
              {daftarBimbinganSkripsi.dashboard.total_group} Kelompok
            </Typography>
          </Div>
        </Div>
        ...
        >
          ...
          <Div>
            ...
            >
              {daftarBimbinganSkripsi.dashboard.not_submitted} Kelompok
            </Typography>
          </Div>
        </Div>
        ...
        >
          ...
          <Div>
            ...
            >
              {daftarBimbinganSkripsi.dashboard.has_submitted} Kelompok
            </Typography>
          </Div>
        </Div>
        ...
        >
          ...
          <Div>
            ...
            >
              {daftarBimbinganSkripsi.dashboard.rejected} Skripsi
            </Typography>
          </Div>
        </Div>
        ...
        >
          ...
          <Div>
            ...
            >
              {daftarBimbinganSkripsi.dashboard.approved} Skripsi
            </Typography>
          </Div>
        </Div>
      </Div>
                            ...
                            (skripsi, skripsiIndex) => (
                              <TableRow key={skripsiIndex}>
                                ...
                                <TableCell>
                                  <Typography
                                    component={Link}
                                    to={`/sistem-informasi-skripsi/daftar-bimbingan-skripsi-co-advisor/beranda/${skripsi.group_id}/${skripsi.status_co_advisor}`}
                                    sx={{
                                      textDecoration: "none",
                                      color: "blue",
                                    }}
                      ...
                      <TableRow key={skripsiIndex}>
                        ...
                        <TableCell sx={{ fontSize: "13px" }}>
                          {skripsi.approve_by_co_advisor1 === null ? (
                            ...
                            />
                          ) : skripsi.approve_by_co_advisor1 === "Approve" ? (
                            <Chip
                              label={"Diterima"}
                              sx={{
                                background: "rgba(21, 131, 67, 0.10)",
                            ...
                            />
                          ) : skripsi.approve_by_co_advisor1 === "Rejected" ? (
                            <Chip
                              label={"Ditolak"}
                              sx={{
                                background: "rgba(226, 29, 18, 0.10)",
                        ...
                        <TableCell sx={{ fontSize: "13px" }}>
                          {skripsi.approve_by_co_advisor2 === null ? (
                            ...
                            />
                          ) : skripsi.approve_by_co_advisor2 === "Approve" ? (
                            <Chip
                              label={"Diterima"}
                              sx={{
                                background: "rgba(21, 131, 67, 0.10)",
                            ...
                            />
                          ) : skripsi.approve_by_co_advisor2 === "Rejected" ? (
                            <Chip
                              label={"Ditolak"}
                              sx={{
                                background: "rgba(226, 29, 18, 0.10)",
...
export default DaftarBimbinganSkripsiCoAdvisor;
