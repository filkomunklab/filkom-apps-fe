...
const MengisiBeritaAcaraProposalDekan = () => {
  ...
  const [DekanStatusBeritaAcara, setDekanStatusBeritaAcara] = useState("Belum");

  const [isSigned, setIsSigned] = useState(false);

  // State untuk mengontrol apakah tombol "Sign" dapat diklik
  const [isSignButtonDisabled, setIsSignButtonDisabled] = useState(false);

  const handleSignClick = () => {
    // Logika untuk mengubah status Berita Acara
    if (!isSigned) {
      setDekanStatusBeritaAcara("Sudah");
      setIsSigned(true);
      // Set tombol "Sign" menjadi disabled
  ...
  // State untuk mengontrol tampilan popup konfirmasi
  ...
  // Fungsi untuk menandatangani
  const handleSign = () => {
    handleOpenConfirmDialog(); // Menampilkan popup konfirmasi
  };
  ...
  return (
    <Div>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <span
                        style={{
                          textDecoration: "none",
                          cursor: isSignButtonDisabled
                            ? "not-allowed"
                            : "pointer",
                          color: isSignButtonDisabled ? "gray" : "blue",
                        }}
                        onClick={() => !isSignButtonDisabled && handleSign()}
                      >
                        Sign
                      </span>
                    </TableCell>
      ...
      {/* konfrimasi Berita Acara End */}
    </Div>
  );
};

export default MengisiBeritaAcaraProposalDekan;
