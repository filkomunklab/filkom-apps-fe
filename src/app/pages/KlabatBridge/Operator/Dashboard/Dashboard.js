...
let filkomStudents = [
  {
    icon: <PeopleIcon style={{ fontSize: 38 }} />,
    topText: "Total Alumni",
    bottomText: "1,324 Students",
  },
  {
    icon: <PeopleIcon style={{ fontSize: 38 }} />,
    topText: "Informatics",
    bottomText: "357 Students",
  },
  {
    icon: <PeopleIcon style={{ fontSize: 38 }} />,
    topText: "Information Systems",
    bottomText: "486 Students",
  },
...
const jenisPerusahaan = [
  ...
  {
    organization: "Institusi/Organisasi Multilateral",
    value: 28,
    color: "#6BFAD7",
  },
  {
    organization: "Organisasi non-profit/Lembaga Swadaya Masyarakat",
    value: 60,
    color: "#128DFF",
  },
  { organization: "Perusahaan Swasta", value: 15, color: "#001AFF" },
  {
    organization: "Wiraswasta/Perusahaan sendiri",
    value: 80,
    color: "#C317FF",
  },
      ...
      <Grid container spacing={3}>
              ...
              <Card>
                <CardHeader
                  ...
                  subheader={
                    ...
                    >{`${data.totalAlumni} students`}</Typography>
                  }
                />
              </Card>
            </Grid>
                ...
                <CardHeader
                  ...
                  subheader={
                    <Typography
                      variant="body2"
                      sx={{ fontSize: "18px", fontWeight: 500 }}
                    >{`${data.totalAlumniIF} students`}</Typography>
                  }
                />
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Card>
                <CardHeader
                  ...
                  title={
                    <Typography variant="h6">Information Systems</Typography>
                  }
                  subheader={
                    <Typography
                      variant="body2"
                      sx={{ fontSize: "18px", fontWeight: 500 }}
                    >{`${data.totalAlumniSI} students`}</Typography>
                  }
                />
              </Card>
            </Grid>
        ...
        <Grid item md={12}>
          <Card sx={{ p: 5 }}>
            <Typography
              variant="h1"
              sx={{ fontSize: "18px", fontWeight: 500, mb: 3 }}
            >
